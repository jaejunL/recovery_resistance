...
gridworld/stats.py     seed bootstrap, Spearman            reference/*.json       per-seed values from the paper's runs
...
exact advantage (`H_down`) vary between executions (see Appendix F).
